package yyyq.portal.feignclient;
...
public interface AuthClient {
    ...
    @PostMapping(value = "/game/getGameNavList")
    ActionResultModel<List<GameNavModel>> getGameNavList(@RequestHeader(SecurityConstants.HEADER_STRING) String token);
}
